        ...
        ZStack {
            ...
            VStack(spacing: 20) {
                HStack {
                    ...
                    // Przycisk "Go to Build" tylko dla armors_background
                    if backgroundImageName == "armors_background" {
                        Button(action: {
                            showBuildScreen.toggle()
                        }) {
                ...
                List(filteredItems) { item in
                    Button(action: {
                        ...
                        HStack {
                            Image(item.imageName)
                                .resizable()
                                .frame(width: (item.category == .armor || item.category == .sword) ? 25 : 50,
                                       height: 50)
                                .clipShape(Rectangle())
